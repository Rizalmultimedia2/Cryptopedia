      ...
      <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 shadow-shadows-1">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div class="flex items-center lg:order-2">
            <a
              href="#"
              class="text-primary-1 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 border border-primary-1 focus:outline-none"
            >
              Daftar
            </a>
            <a
          ...
          >
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              ...
              <li>
                <a
                  href="#"
                  class="block py-2 pr-4 pl-3 text-black border-b border-gray-100 hover:text-primary-1 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0"
                >
                  Artikel
                </a>
              </li>
